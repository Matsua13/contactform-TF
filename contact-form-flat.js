document.addEventListener('DOMContentLoaded', function() {
    const form = document.querySelector('.contact-form.flat');
    const nameInput = document.getElementById('name-flat');
    const emailInput = document.getElementById('email-flat');
    const subjectInput = document.getElementById('subject-flat');
    const phoneInput = document.getElementById('phone-flat');
    const messageInput = document.getElementById('message-flat');
